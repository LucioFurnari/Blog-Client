    ...
    <nav className="container mx-auto px-6 py-3">
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleBurgerMenu} className="outline-none mobile-menu-button">
          <svg className={`${hamburgerMenu && 'border-2 border-gray-400 rounded-md'} w-6 h-6 text-white`} x-show="!showMenu" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
